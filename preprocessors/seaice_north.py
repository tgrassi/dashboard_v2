...
def preprocess():
    ...
    df = pd.read_csv("data/N_seaice_extent_daily_v4.0.csv", skiprows=2, comment='#', names=["Year", "Month", "Day", "Extent", "Missing", "Source Data"])
    ...
    with open('website/data/seaice_north.json', 'w') as f:
